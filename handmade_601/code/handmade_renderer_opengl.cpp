...
internal void
UseProgramBegin(open_gl *OpenGL, zbias_program *Prog, render_setup *Setup, f32 AlphaThreshold)
{
    ...
    OpenGL->glUniform3fv(Prog->VoxelMinCorner, 1, Setup->VoxelMinCorner.E);
    OpenGL->glUniform3fv(Prog->VoxelInvTotalDim, 1, Setup->VoxelInvTotalDim.E);
}
...
internal void
CompileZBiasProgram(open_gl *OpenGL, zbias_program *Result, b32x DepthPeel, b32x LightingDisabled, v3s VoxelDim)
{
...
OpenGLChangeToSettings(open_gl *OpenGL, game_render_settings *Settings)
{
    ...
    CompileZBiasProgram(OpenGL, &OpenGL->ZBiasNoDepthPeel, false, OpenGL->CurrentSettings.LightingDisabled, OpenGL->SpecularLightAtlas.VoxelDim);
    CompileZBiasProgram(OpenGL, &OpenGL->ZBiasDepthPeel, true, OpenGL->CurrentSettings.LightingDisabled, OpenGL->SpecularLightAtlas.VoxelDim);
        ...
        )
    {
        ...
        switch(Header->Type)
        {
            ...
            case RenderGroupEntryType_render_entry_textured_quads:
            {
                ...
                UseProgramBegin(OpenGL, Prog, Setup, AlphaThreshold);
