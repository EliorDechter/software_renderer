...
set CommonCompilerFlags=-DHANDMADE_INTERNAL=0 -DHANDMADE_SLOW=0 -DHANDMADE_WIN32=1 %CommonCompilerFlags%
...
cl %CommonCompilerFlags% -D_CRT_SECURE_NO_WARNINGS ..\handmade\code\hhlightprof.cpp /link %CommonLinkerFlags%
