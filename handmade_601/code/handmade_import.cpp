...
ImportBody(game_assets *Assets, u32 XIndex, u32 YIndex)
{
    ...
    if(XIndex <= 6)
    {
        ...
        AddTag(&Builder, Tag_FacingDirection, ((f32)(YIndex % 4) * Tau32) / 4.0f);
...
CreateArtHandTagGrid(game_assets *Assets, import_grid_tags *Tags)
{
        ...
        ++YIndex)
    {
            ...
            ++XIndex)
        {
            ...
            {
                tag_builder Builder = BeginTags(Assets);
                AddTag(&Builder, Tag_FacingDirection, ((f32)YIndex * Tau32) / 4.0f);
                          ...
                          u32 AssetIndex, import_grid_tag Tags)
{
    ...
    if(Tags.TypeID)
    {
        if(Asset->Type == 0)
        {
            SetAssetType(Assets, AssetIndex, Tags.TypeID);
        }
    }
    else
    {
