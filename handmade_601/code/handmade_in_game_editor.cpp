...
CameraEditor(dev_ui_layout *Layout, game_mode_world *WorldMode)
{
    ...
    Labelf(Layout, "ExpectedFloorMinZ: %.02f -> %.02f",
           WorldMode->Camera.ExpectedFocusMinZ,
           WorldMode->Camera.TargetExpectedFocusMinZ);
    Labelf(Layout, "ExpectedFloorMaxZ: %.02f -> %.02f",
           WorldMode->Camera.ExpectedFocusMaxZ,
           WorldMode->Camera.TargetExpectedFocusMaxZ);
