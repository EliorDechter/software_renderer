...
internal entity_visible_piece *AddPiece(entity *Entity, asset_basic_category AssetCategory, v3 Dim, v3 Offset, v4 Color, u32 Flags = 0);
internal entity_visible_piece *AddPiece(entity *Entity, asset_basic_category AssetCategory, f32 Height, v3 Offset, v4 Color, u32 Flags = 0);
