...
#define INTRO_SHOT(Index) Asset_Plate, Index, ArrayCount(IntroLayers##Index), IntroLayers##Index
                           ...
                           game_input *Input, game_mode_title_screen *TitleScreen)
{
    ...
    if(!Result)
    {
        ...
        else
        {
            ...
            asset_vector MatchVector = {};
            asset_vector WeightVector = {};
            WeightVector.E[Tag_TitleScreen] = 10.0f;
            WeightVector.E[Tag_ShotIndex] = 10.0f;
            WeightVector.E[Tag_LayerIndex] = 1.0f;
            MatchVector.E[Tag_TitleScreen] = 1.0f;
            MatchVector.E[Tag_ShotIndex] = 1.0f;
            MatchVector.E[Tag_LayerIndex] = 1.0f;
            bitmap_id LayerImage = GetBestMatchBitmapFrom(Assets, Asset_Plate, &MatchVector, &WeightVector);
