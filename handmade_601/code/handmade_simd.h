...
internal f32
Extract0(f32_4x Value)
{
    f32 Result = _mm_cvtss_f32(Value.P);
    return(Result);
}

internal f32
Extract1(f32_4x Value)
{
    int WhatIsIntelDoingHere = _mm_extract_ps(Value.P, 1);
    f32 Result = *(f32 *)&WhatIsIntelDoingHere;
    
    return(Result);
}

internal f32
Extract2(f32_4x Value)
{
    int WhatIsIntelDoingHere = _mm_extract_ps(Value.P, 2);
    f32 Result = *(f32 *)&WhatIsIntelDoingHere;
